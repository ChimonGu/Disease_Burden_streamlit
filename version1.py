...
def main():
    ...
    with col2:
        if st.button("数据来源", key="introduction"):
...
def homepage():
    ...
    <p style='text-indent: 2em; font-size: 20px; line-height: 2.0;'>
             糖尿病作为一种营养代谢性疾病，已成为慢性非传染性疾病的重要组成部分，每年全球因此丧生的病例高达160万<sup>[1]</sup>。
             近年来，随着生活方式的变迁和饮食结构的改变，糖尿病患病率逐年上升，严重危害居民健康，成为当前社会亟待解决的重大公共卫生挑战。预计到2045年，全球将有高达7.83亿人受到糖尿病的困扰<sup>[2]</sup>。
             过去30年，我国糖尿病患病率显著上升，2002年患病率首次超过全球平均水平，并在2002－2016年间始终高于平均全球水平<sup>[3]</sup>，但该病的知晓率及治愈率仍处于低水平<sup>[4,5]</sup>。
             本平台展示我国糖尿病疾病负担的现状与1900-2021年的发展趋势，并采用多种预测模型，预测不同场景下我国未来糖尿病疾病负担的发展趋势。
    <p>
...
def display_forecast():
    ...
    with col1:
        st.button("显示预测结果", key="forecast_button", on_click=show_forecast)
